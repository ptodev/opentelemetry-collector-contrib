...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/config/attraction v0.67.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/config/filter v0.0.0-00010101000000-000000000000
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/pkg/config/attraction => ../../pkg/config/attraction
