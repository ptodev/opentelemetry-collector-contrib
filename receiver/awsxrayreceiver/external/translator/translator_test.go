...
func TestTranslation(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			samplePath: filepath.Join("../../../../external/aws/xray", "testdata", "serverSample.txt"),
			expectedResourceAttrs: func(seg *awsxray.Segment) map[string]interface{} {
		...
		},
		{
			...
			samplePath: filepath.Join("../../../../external/aws/xray", "testdata", "ddbSample.txt"),
			expectedResourceAttrs: func(seg *awsxray.Segment) map[string]interface{} {
				return map[string]interface{}{
					conventions.AttributeCloudProvider:        conventions.AttributeCloudProviderAWS,
					conventions.AttributeTelemetrySDKVersion:  *seg.AWS.XRay.SDKVersion,
		...
		},
		{
			...
			samplePath: filepath.Join("../../../../external/aws/xray", "testdata", "awsMissingAwsField.txt"),
			expectedResourceAttrs: func(seg *awsxray.Segment) map[string]interface{} {
				return map[string]interface{}{
		...
		},
		{
			...
			samplePath: filepath.Join("../../../../external/aws/xray", "testdata", "awsValidAwsFields.txt"),
			expectedResourceAttrs: func(seg *awsxray.Segment) map[string]interface{} {
				return map[string]interface{}{
					conventions.AttributeCloudProvider:         conventions.AttributeCloudProviderAWS,
		...
		},
		{
			...
			samplePath: filepath.Join("../../../../external/aws/xray", "testdata", "minCauseIsExceptionId.txt"),
			expectedResourceAttrs: func(seg *awsxray.Segment) map[string]interface{} {
				return map[string]interface{}{
					conventions.AttributeCloudProvider: "unknown",
				}
		...
		},
		{
			...
			samplePath: filepath.Join("../../../../external/aws/xray", "testdata", "invalidNamespace.txt"),
			expectedResourceAttrs: func(seg *awsxray.Segment) map[string]interface{} {
				return nil
			},
			propsPerSpan: func(_ string, _ *testing.T, seg *awsxray.Segment) []perSpanProperties {
		...
		},
		{
			...
			samplePath: filepath.Join("../../../../external/aws/xray", "testdata", "indepSubsegment.txt"),
			expectedResourceAttrs: func(seg *awsxray.Segment) map[string]interface{} {
				return map[string]interface{}{
					conventions.AttributeCloudProvider: "unknown",
				}
		...
		},
		{
			...
			samplePath: filepath.Join("../../../../external/aws/xray", "testdata", "indepSubsegmentWithContentLengthString.txt"),
			expectedResourceAttrs: func(seg *awsxray.Segment) map[string]interface{} {
				return map[string]interface{}{
					conventions.AttributeCloudProvider: "unknown",
				}
		...
		},
		{
			...
			samplePath: filepath.Join("../../../../external/aws/xray", "testdata", "indepSubsegmentWithSql.txt"),
			expectedResourceAttrs: func(seg *awsxray.Segment) map[string]interface{} {
				return map[string]interface{}{
					conventions.AttributeCloudProvider: "unknown",
				}
		...
		},
		{
			...
			samplePath: filepath.Join("../../../../external/aws/xray", "testdata", "indepSubsegmentWithInvalidSqlUrl.txt"),
			expectedResourceAttrs: func(seg *awsxray.Segment) map[string]interface{} {
				return nil
			},
			propsPerSpan: func(_ string, _ *testing.T, seg *awsxray.Segment) []perSpanProperties {
		...
		},
		{
			...
			samplePath:                filepath.Join("../../../../external/aws/xray", "testdata", "minCauseIsInvalid.txt"),
			expectedResourceAttrs: func(seg *awsxray.Segment) map[string]interface{} {
				return nil
			},
			propsPerSpan: func(_ string, _ *testing.T, seg *awsxray.Segment) []perSpanProperties {
		...
		},
		{
			...
			samplePath: filepath.Join("../../../../external/aws/xray", "testdata", "segmentValidationFailed.txt"),
			expectedResourceAttrs: func(seg *awsxray.Segment) map[string]interface{} {
				return nil
			},
			propsPerSpan: func(_ string, _ *testing.T, seg *awsxray.Segment) []perSpanProperties {
