...
package ec2 // import "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/datadogexporter/external/metadata/external/ec2"
...
func (p *Provider) instanceTags(ctx context.Context) (*ec2.DescribeTagsOutput, error) {
	...
	// Similar to:
	// - https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/39dbc1ac8/processor/resourcedetectionprocessor/external/aws/ec2/ec2.go#L118-L151
