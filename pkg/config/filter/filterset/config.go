...
package filterset // import "github.com/open-telemetry/opentelemetry-collector-contrib/pkg/config/filter/filterset"

import (
	"fmt"

	"github.com/open-telemetry/opentelemetry-collector-contrib/pkg/config/filter/filterset/regexp"
	"github.com/open-telemetry/opentelemetry-collector-contrib/pkg/config/filter/filterset/strict"
)
